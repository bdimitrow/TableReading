//
// Created by bozhidar on 5/15/20.
//

#ifndef TABLEREADING_HETEROGENEOUSCONTAINER_H
#define TABLEREADING_HETEROGENEOUSCONTAINER_H
...
#endif //TABLEREADING_HETEROGENEOUSCONTAINER_H
